...
#from tensorflow.keras.applications.vgg19 import preprocess_input  # or vgg19.preprocess_input
...
base_model.add(Input(shape=(152, 152, 3), name='Input'))
base_model.add(Conv2D(32, (11, 11), activation='relu', name='C1'))
base_model.add(MaxPooling2D(pool_size=(3, 3), strides=(2, 2), padding='same', name='M2'))
base_model.add(Conv2D(16, (9, 9), activation='relu', name='C3'))
# Note: Using Conv2D as an alternative for LocallyConnected2D for the sake of this example
base_model.add(Conv2D(16, (9, 9), activation='relu', name='L4'))
base_model.add(Conv2D(16, (7, 7), strides=(2, 2), activation='relu', name='L5'))
base_model.add(Conv2D(16, (5, 5), activation='relu', name='L6'))
base_model.add(Flatten(name='F0'))
base_model.add(Dense(4096, activation='relu', name='F7'))
base_model.add(Dropout(rate=0.5, name='D0'))
base_model.add(Dense(8631, activation='softmax', name='F8'))

base_model.load_weights(r'C:\Users\alex\OneDrive\Masaüstü\git\opencv\pythonProject\weights\VGGFace2_DeepFace_weights_val-0.9034.h5')

# Drop F8 and D0 layers. F7 is the representation layer.
model = Model(inputs=base_model.input, outputs=base_model.get_layer('F7').output)
...
employee_pictures = r'C:\Users\alex\OneDrive\Masaüstü\git\opencv\pythonProject\database'
